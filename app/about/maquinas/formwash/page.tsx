          ...
          <div className="lg:col-span-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl overflow-hidden">
            <div className="p-8">
              ...
              <p className="mt-3 text-gray-300">
                Sistema automatizado de lavado para piezas impresas en resina (SLA/LFS).
              </p>

              <div className="mt-8 relative w-full h-64 rounded-xl overflow-hidden border border-white/10">
                <Image src="/formwash.jpg" alt="Form Wash" fill className="object-cover" />
                <div className="absolute inset-0 bg-black/35" />
              </div>

              <div className="mt-8 space-y-4 text-gray-200 leading-relaxed">
                <p>
                  La Form Wash es un sistema automatizado de lavado diseñado por Formlabs para limpiar
                  piezas impresas en resina de manera eficiente y consistente. Utiliza agitación controlada
                  con IPA u otros solventes compatibles para remover el exceso de resina no curada,
                  asegurando superficies limpias y uniformes sin intervención manual.
                </p>

                <p>
                  Su ciclo automatizado, temporizador integrado y opción de lavado directo con la plataforma
                  de impresión reducen errores, mejoran la repetibilidad del proceso y preparan las piezas
                  para un curado final óptimo. Es una herramienta esencial para un flujo de trabajo seguro,
                  limpio y estandarizado en impresión 3D de resina.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-xl p-6">
              ...
              <p className="mt-2 text-gray-400 text-sm">
                Archivos útiles para lavado (WIs, solventes aprobados, checklists, etc.).
              </p>
              ...
              {isAdmin && (
                <div className="mt-5 text-xs text-gray-500">
                  Sugerencia: sube checklist de cambio de IPA y guías de seguridad.
                </div>
              )}
            </div>
          </div>
