          ...
          <div className="lg:col-span-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl overflow-hidden">
            <div className="p-8">
              ...
              <p className="mt-3 text-gray-300">
                Termoformadora de escritorio para moldes, empaques y prototipos rápidos.
              </p>

              <div className="mt-8 relative w-full h-64 rounded-xl overflow-hidden border border-white/10">
                <Image src="/mayku.jpg" alt="Mayku" fill className="object-cover" />
                <div className="absolute inset-0 bg-black/35" />
              </div>

              <div className="mt-8 space-y-4 text-gray-200 leading-relaxed">
                <p>
                  La Mayku FormBox es una termoformadora de escritorio diseñada para crear moldes y piezas
                  personalizadas de forma rápida y sencilla. Es ideal para prototipado, fabricación de
                  empaques, moldes para colada y proyectos creativos, gracias a su facilidad de uso y tamaño
                  compacto.
                </p>

                <p>
                  Cuenta con un área de moldeo de 200 x 200 mm y una altura máxima de formación de 130 mm.
                  Funciona con hojas de plástico termoformable y se conecta a una aspiradora doméstica para
                  generar el vacío durante el proceso.
                </p>

                <p>
                  Es compatible con materiales termoformables como HIPS, PETG, ABS, polipropileno y hojas
                  biodegradables. También permite trabajar con masters (moldes) de madera, metal, arcilla,
                  resina, jabón y otros materiales que resistan la temperatura del proceso.
                </p>

                <p>
                  Ventajas: rapidez en la creación de moldes, portabilidad, bajo consumo energético y
                  capacidad de producir series pequeñas sin maquinaria industrial.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-xl p-6">
              ...
              <p className="mt-2 text-gray-400 text-sm">
                Archivos útiles (WIs, plantillas para moldes, tips de termoformado, etc.).
              </p>
              ...
              {isAdmin && (
                <div className="mt-5 text-xs text-gray-500">
                  Sugerencia: sube hojas termoformables aprobadas y checklist de setup.
                </div>
              )}
            </div>
          </div>
