          ...
          <div className="lg:col-span-3 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-2xl overflow-hidden">
            <div className="p-8">
              ...
              <p className="mt-3 text-gray-300">
                Impresora LFS optimizada para aplicaciones profesionales y médicas.
              </p>

              <div className="mt-8 relative w-full h-64 rounded-xl overflow-hidden border border-white/10">
                <Image src="/formlabs3B.jpg" alt="Formlabs 3B" fill className="object-cover" />
                <div className="absolute inset-0 bg-black/35" />
              </div>

              <div className="mt-8 space-y-4 text-gray-200 leading-relaxed">
                <p>
                  La Formlabs Form 3B es una impresora 3D de tecnología LFS (Low Force Stereolithography)
                  optimizada para aplicaciones profesionales y médicas. Utiliza resina líquida fotosensible
                  que se cura capa por capa con un sistema láser avanzado, ofreciendo piezas con alta
                  precisión y acabados extremadamente finos.
                </p>

                <p>
                  Su volumen de impresión es de 145 x 145 x 185 mm, con una resolución mínima de 25 micras.
                  Su tanque flexible y óptica de alta calidad reduce fuerzas de desprendimiento, prolongando
                  la vida útil de consumibles y mejorando la calidad.
                </p>

                <p>
                  Compatible con resinas de ingeniería y opciones biocompatibles/grado médico, ideal para
                  odontología, ortopedia, fabricación de dispositivos médicos y prototipado de precisión.
                  El software PreForm optimiza orientación y soportes.
                </p>

                <p>
                  Ventajas: calidad superficial superior, alta repetibilidad, conectividad por Wi-Fi,
                  Ethernet y USB, y flujo de trabajo optimizado para uso intensivo.
                </p>
              </div>
            </div>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md shadow-xl p-6">
              ...
              <p className="mt-2 text-gray-400 text-sm">
                Archivos útiles (resinas, guías, presets, WIs, etc.).
              </p>
              ...
              {isAdmin && (
                <div className="mt-5 text-xs text-gray-500">
                  Sugerencia: sube resinas aprobadas, guías internas y checklists.
                </div>
              )}
            </div>
          </div>
